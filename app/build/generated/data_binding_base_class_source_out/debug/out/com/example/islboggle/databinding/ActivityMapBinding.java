...
public final class ActivityMapBinding implements ViewBinding {
  ...
  private ActivityMapBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView recyclerView) {
  ...
  public static ActivityMapBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMapBinding((LinearLayout) rootView, recyclerView);
    }
